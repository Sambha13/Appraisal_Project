      ...
      <div id="multiStepForm" class="card">
        <div class="card-header">
          <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link" id="profileone" data-toggle="tab" href="#one" role="tab" aria-controls="one" aria-selected="false">Step2</a>
            </li>
...
<section class="container">
        ...
        <div class="subheader">
            <div class="subtitle"> 4 Professional Development - Desirable Activity</div>
        ...
        <table class="table w-100 ">
            ...
            <tr>
                    <td>4.1.1</td>
                    <td>Research Publication (International Journals).
                        <table class="table table-bordered">
        
                            <tr>
                                <td>Number of Papers in International Journals</td>
                        ...
                        <div class="dropdown1">
                            ...
                            <div class="dropdown-content">
                                <ol>
                                    ...
                                    <li>For 1 Scopus Indexed, Marks = 20</li>
                                    <li>For 1 Web of Science Indexed, Marks = 20</li>
                                    <li>For 1 UGC Care, Marks = 10</li>
                                </ol>
                                <p><strong>Decision-Making:</strong>Prestige and Rigor: Web of Science is often accorded more marks due to its perceived prestige and the rigorous selection criteria of its indexed journals.
Broader Coverage and Inclusivity: Scopus might be given more marks in contexts where broader coverage and inclusivity are valued.
</p> 
                              <p><strong>Committee Involved:</strong>Reasearch Committee (RC)</p>
                              <p><strong>Input Data:</strong> RC csv File</p>
                ...
                <tr>
                    <td>4.1.2</td>
                    <td>Research Publication (National Journals)
                        <table class="table table-bordered">
                            
                            <tr>
                                <td>Number of Papers in National Journals</td>
                                <td><input type="number"></td>
                        ...
                        <div class="dropdown1">
                            ...
                            <div class="dropdown-content">
                                <ol>
                                    <li>The Journal should have ISSN number</li>
                                    <li>For 1 Paper, Marks = 5</li>
                ...
                <tr>
                    <td>4.1.3</td>
                    <td>Research Publication (Conference).
                        <table class="table table-bordered">
                            
                            <tr>
                                <td>Number of Papers in Conference</td>
                                <td><input type="number"></td>
                        ...
                        <div class="dropdown1">
                            ...
                            <div class="dropdown-content">
                                <ol>
                                    ...
                                    <li>For International Conference, Marks = 10</li>
                                    <li>For National Conference, Marks = 5</li>
                                    <p>If 1 International and 1 national then ?</p>
                                </ol>
    ...
    <div class="subheader">
        ...
        <table class="table w-100 ">
            ...
            <tr>
                        ...
                        <div class="dropdown1">
                            ...
                            <div class="dropdown-content">
                                <ol>
                                    ...
                                    <li>The book should have ISBN number</li>
                                    <li>For book, Marks = 10</li>
                                    <li>For book chapter, Marks = 5</li>
                                    <p>We should have some quality benchmark with respect to publisher, adoption,usage and reviews</p>
                                </ol>
                                <p><strong>Committee Involved:</strong> Faculty Activity Committee (FAC)</p>
                                <p><strong>Input Data:</strong> FAC csv File</p>
                ...
                <tr>
                    <td>4.1.5</td>
                    <td>Involvement in Research Activities
                        <table class="table table-bordered">
        
                            <tr>
                                <td>Number of Activities Involved</td>
                                <td><input type="number"></td>
                        ...
                        <div class="dropdown1">
                            ...
                            <div class="dropdown-content">
                                <ol>
                                    ...
                                    <li>Students opted PG/Ph.D. admissions through encouragement (How do we quantify?)</li>
                                    <li>Organization of research awareness program</li>
                                    <li>Submission of Research Proposal</li>
                                    <li>Encourage students for project competition</li>
                                    <li>Undertake project with specialized theme, social needs, interdisciplinary, etc.</li>                               <li>Encourage students for project competition</li>
                                    <li>Obtained sponsored project from industry</li>
                                    <li>For each activity, Marks = 10 and then compute out of 20 ?</li>
