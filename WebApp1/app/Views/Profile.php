              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">Bhushan Nikam</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Employee Code</div>
                    <div class="col-lg-9 col-md-8">SIBAR</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Stream</div>
                    <div class="col-lg-9 col-md-8">Facalty</div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">MCA</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Phone</div>
                    <div class="col-lg-9 col-md-8">Shift</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Designation</div>
                    <div class="col-lg-9 col-md-8">Assistant Professor</div>
                  </div>
                  
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Email</div>
                    <div class="col-lg-9 col-md-8">bhushannikam@sinhgad.idu</div>
                  </div>
                  
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Mobile Number </div>
                    <div class="col-lg-9 col-md-8">8530087540</div>
                  </div>
                  
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Date Of Joining</div>
                    <div class="col-lg-9 col-md-8">07/02/2020</div>
                  </div>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="fullName" type="text" class="form-control" id="fullName" value="Bhushan Nikam">
                      </div>
                    </div>

                    <div class="row mb-3">
                      <label for="employee_code" class="col-md-4 col-lg-3 col-form-label">Employee Code</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="employee_code" type="text" class="form-control" id="employee_code" value="f2a1234">
                      </div>
                    </div>

                    <div class="row mb-3">
                      <label for="stream" class="col-md-4 col-lg-3 col-form-label">stream</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="stream" type="text" class="form-control" id="stream" value="#">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="institute" type="text" class="form-control" id="institute" value="SIBAR">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="department" type="text" class="form-control" id="department" value="MCA">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="shift" type="text" class="form-control" id="shift" value="Morning">
                      </div>
                    </div>
                    <div class="row mb-3">
                      <label for="designation" class="col-md-4 col-lg-3 col-form-label">Designation</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="designation" type="text" class="form-control" id="designation" value="Assistant Professor">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="email" type="email" class="form-control" id="Email" value="bhushannikam@sinhgadinstitute.idu">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="mobilenumber" type="text" class="form-control" id="mobilenumber" value="(+91) 8530087540">
                      </div>
                    </div>
                    <div class="row mb-3">
                      <label for="dateofjoining" class="col-md-4 col-lg-3 col-form-label">Date Of Joining</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="dateofjoining" type="text" class="form-control" id="dateofjoining" value="07/08/2020">
                      </div>
                    </div>
