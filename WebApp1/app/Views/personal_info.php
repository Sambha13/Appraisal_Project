...
<head>
  ...
  <title>sinhgad Institute Portal</title>
    ...
    <div class="col-lg-12" >
      ...
      <div class="card">
        <div class="card-body text-center" >
          ...
          <div class="row">             
            <div class="row mb-3">
              <label for="inputEmail" class="col-sm-2 col-form-label">Employee Code</label>
              <div class="col-sm-10 ">
            ...
            <div class="mb-3 row ">
              ...
              <div class="col-sm-10 ">
                <input type="email" class="form-control" disabled value="xyz@gmail.com">
              </div>
            </div>
